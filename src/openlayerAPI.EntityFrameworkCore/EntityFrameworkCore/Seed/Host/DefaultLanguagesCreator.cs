...
namespace openlayerAPI.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly openlayerAPIDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = openlayerAPIConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(openlayerAPIDbContext context)
        {
            _context = context;
        }
